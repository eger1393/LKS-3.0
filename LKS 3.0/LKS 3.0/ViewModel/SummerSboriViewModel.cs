...
namespace LKS_3._0.ViewModel
{
    ...
    internal class SummerSboriViewModel : INotifyPropertyChanged
    {
        ...
        private BindingList<Model.Admin> _admins;
        private BindingList<Student> students;
        private BindingList<Prepod> prepods;
        private Model.Admin selectAdmin;
        ...
        private readonly string[,] pathTemplate =
        {
            { // 0 вкладка
                ...
                "Сборы_вечерняя_поверка_общая.docx",
                "Сборы_вечерняя_поверка_общая.docx",//
				"Сборы_ВПД.docx",
                "none",
                "none",
        ...
        public SummerSboriViewModel(ref ApplicationContext temp_DataBase, BindingList<Troop> _troops, bool data)
        {
            ...
            SelectedSummerSbori = this.temp_DataBase.Summers.Local.ToBindingList().FirstOrDefault();
